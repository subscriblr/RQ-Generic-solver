...
auto s = RQ_solver<int, method::set>(data);
cout << s.get_name() << endl; //empty_solver
s.set(3, 100);

auto s2 = RQ_solver<int, method::get_range, property::inversible>(data, [](int a, int b) {return a + b;}, [](int a) {return -a;});
...
auto s4 = RQ_solver<int, method::get_range, property::inversible, method::set>(data, [](int a, int b) {return a + b;}, [](int a) {return -a;});
...
auto s6 = RQ_solver<int, method::get_range, method::set_range>(data, [](int a, int b) {return a + b;});
cout << s6.get_name() << endl;   //segment tree with delayed midifications
cout << s6.get_range(1, 5) << endl;//10
s6.set_range(3, 6, 0);
cout << s6.get_range(1, 5) << endl;//3

auto s7 = RQ_solver<int, method::get_range, method::set_range>(data, [](int a, int b) {return a + b;}, [](int a, int len){ return a * len;});
